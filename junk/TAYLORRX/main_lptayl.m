...
%         c(n)=1e12; % All - partial modes are made costlier        
 ...
 SS_set = SlipSystem(n); 
 n_ssset = length(SS_set);
 %%
 dummySystem = SS_set(1);
 dummySystem.m.M = [0,0,0;0,0,0;0,0,0];
 dummySystem.q.M = [0,0,0;0,0,0;0,0,0];
 dummySystem.beta.M = [0,0,0;0,0,0;0,0,0];
 SS_set(n_ssset+1:n_ssset+5) = dummySystem;
 %%
switch constraints
    case 1 %only 13
       c(n_n+1:n_n+2) = [0,0];
...
for i=1:1:lg, 
    ...
    A13 = [RC13(1,1),-RC13(1,1);RC13(2,2),-RC13(2,2);(RC13(2,3)+RC13(3,2)),...
        -(RC13(2,3)+RC13(3,2));(RC13(1,3)+RC13(3,1)),-(RC13(1,3)+RC13(3,1));...
        (RC13(1,2)+RC13(2,1)),-(RC13(1,2)+RC13(2,1))];
    A23 = [RC23(1,1),-RC23(1,1);RC23(2,2),-RC23(2,2);(RC23(2,3)+RC23(3,2)),...
        -(RC23(2,3)+RC23(3,2));(RC23(1,3)+RC23(3,1)),-(RC23(1,3)+RC23(3,1));...
        (RC23(1,2)+RC23(2,1)),-(RC23(1,2)+RC23(2,1))];
    A12 = [RC12(1,1),-RC12(1,1);RC12(2,2),-RC12(2,2);(RC12(2,3)+RC12(3,2)),...
        -(RC12(2,3)+RC12(3,2));(RC12(1,3)+RC12(3,1)),-(RC12(1,3)+RC12(3,1));...
        (RC12(1,2)+RC12(2,1)),-(RC12(1,2)+RC12(2,1))];
    % Relax constraint set
    Arc = [A,A13(:,1),A23(:,1),A12(:,1),A13(:,2),A23(:,2),A12(:,2)]; 
