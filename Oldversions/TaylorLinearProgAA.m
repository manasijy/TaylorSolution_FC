% In this version of TaylorLinearProg shears are taken as simply eij,
% instead of 2*eij
...
beq = [e_grain(1,1);e_grain(2,2);e_grain(2,3);e_grain(1,3);e_grain(1,2)]; 
...
lb = zeros(1,24);
ub = 10*( ones(1,24));
% x0 = [0,0,0,0,0,0,0.6123,0,0,0,0.6123,0,0,0,0,0.6123,0.6123,0,0,0,0,0,0,0];
