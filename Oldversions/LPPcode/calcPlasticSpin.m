...
switch criteria 
    case minvar
        UniqueSolution = uniqueSol_minVar(TaylorSolution);
    case maxvar
        UniqueSolution = uniqueSol_maxVar(TaylorSolution);
    case minplasticspin
        UniqueSolution = uniqueSol_MinPlasticSpin(TaylorSolution);
end
...
SS= SlipSystem(UniqueSolution.B);
shear = UniqueSolution.xb;
spin.min = zeros(3,3);
spin.max = zeros(3,3);
