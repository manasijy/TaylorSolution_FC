...
for i=1:1:lg, 
    ...
    rotdcmat = spin2mat(spin_min);%matlab returns component dc matrix
    dcg1=  rotdcmat'*DCMtrx'; % final axis orientation = axis tr dcm of rotation *axis tr dcm of initial ori
    gmatrix(i) = rotation('matrix',dcg1); 
% here again we are using matlab
%     fn so we have to use component tr matrix. For matlab dcm means
%     components.

 %% Note: Whenever we use matlab dcm fns we are getting component tr dcm
 % We need to transpose it to get axis tr matx
%% 
