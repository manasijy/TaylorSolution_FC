function [TaylorSolution, varArray,o0] = fcsol(gvector)
...
o1=orientation(rotmin,crystalSymmetry('-43m'),specimenSymmetry('mmm'))*o0;
% figure
...
plotPDF(o0,Miller(1,1,1,cs),'complete',axesPos,'MarkerSize',3) % This has to be repeated twice to plot o0 also - A Quick Fix
axesPos = subplot(1,3,1);
plotPDF(o0,Miller(1,1,1,cs),'complete','parent',axesPos,'MarkerSize',3)
axesPos = subplot(1,3,2);
plotPDF(o1,Miller(1,1,1,cs),'complete','parent',axesPos,'MarkerSize',3)
axesPos = subplot(1,3,3);
plotPDF(o2,Miller(1,1,1,cs),'complete','parent',axesPos,'MarkerSize',3)
Euler(o0)
Euler(o1)
Euler(o2)
